...
export class DeploymentConfigService {
  ...
  async update(id: string, updateDto: UpdateDeploymentConfigDto): Promise<DeploymentConfig> {
    ...
    if (updateDto.cpuLimit) config.cpu_limit = typeof updateDto.cpuLimit === 'string' ? Number(updateDto.cpuLimit) : updateDto.cpuLimit;
    if (updateDto.memoryLimit) config.memory_limit = typeof updateDto.memoryLimit === 'string' ? Number(updateDto.memoryLimit) : updateDto.memoryLimit;
